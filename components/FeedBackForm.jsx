  ...
  return (
    <div className="rounded-[2rem] border border-slate-300 bg-white shadow-2xl shadow-slate-200/70 p-8 sm:p-10">
      ...
      <form action={formAction} className="space-y-6">
        ...
        <button className="w-full rounded-full bg-green-400 px-8 py-4 text-base font-semibold text-white shadow-xl shadow-teal-600/20 transition hover:bg-teal-700 cursor-pointer">

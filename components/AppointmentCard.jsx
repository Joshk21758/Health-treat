...
export default function AppointmentCard({ appointment }) {
  ...
  return (
    <div className="w-full max-w-4xl rounded-[2rem] border border-green-200 bg-white p-8 shadow-xl shadow-slate-200/80 sm:p-10">
      <div className="flex flex-col gap-4 border-b border-rose-200 pb-6 sm:flex-row sm:items-start sm:justify-between">
        <div>
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        <Link
          ...
          className="rounded-full bg-neutral-800 px-5 py-3 text-sm font-semibold text-white transition hover:bg-rose-500"
        >
